...
namespace eval Word {
    ...
    variable wdClassicBlue 18
    variable wdClassicRed 17
    ...
    variable wdAllowHyphenationAtTrackBottom 71
    ...
    variable wdUsePre2018iOSMacLayout 73
    ...
    variable wdUseWord2013TrackBottomHyphenation 72
    ...
    # Enumeration WdPageMovementType
    variable wdSideToSide 2
    variable wdVertical 1
    ...
    namespace eval Enum {
        ...
        proc WdApplyQuickStyleSets {} {
            # wdSessionStartSet - 1
            # wdTemplateSet - 2
            return { wdSessionStartSet 1 wdTemplateSet 2 }
        }

        proc WdArabicNumeral {} {
            # wdNumeralArabic - 0
            # wdNumeralContext - 2
            # wdNumeralHindi - 1
            # wdNumeralSystem - 3
        ...
        proc WdCaptionNumberStyleHID {} {
            # emptyenum - 0
            return { emptyenum 0 }
        }

        proc WdCaptionPosition {} {
        ...
        proc WdCharacterCaseHID {} {
            # emptyenum - 0
            return { emptyenum 0 }
        }

        proc WdCharacterWidth {} {
            # wdWidthFullWidth - 7
            # wdWidthHalfWidth - 6
            return { wdWidthFullWidth 7 wdWidthHalfWidth 6 }
        }

        proc WdCheckInVersionType {} {
        ...
        proc WdContentControlAppearance {} {
        ...
        proc WdContentControlDateStorageFormat {} {
        ...
        proc WdDictionaryTypeHID {} {
            # emptyenum - 0
            return { emptyenum 0 }
        }

        proc WdDisableFeaturesIntroducedAfter {} {
            # wd70 - 0
            # wd70FE - 1
            # wd80 - 2
        ...
        proc WdEndnoteLocation {} {
            # wdEndOfDocument - 1
            # wdEndOfSection - 0
            return { wdEndOfDocument 1 wdEndOfSection 0 }
        }

        proc WdEnvelopeOrientation {} {
            # wdCenterClockwise - 7
            # wdCenterLandscape - 4
            # wdCenterPortrait - 1
            # wdLeftClockwise - 6
        ...
        proc WdFarEastLineBreakLanguageID {} {
        ...
        proc WdFootnoteLocation {} {
            # wdBeneathText - 1
            # wdBottomOfPage - 0
            return { wdBeneathText 1 wdBottomOfPage 0 }
        }

        proc WdFramePosition {} {
        ...
        proc WdFramesetNewFrameLocation {} {
        ...
        proc WdHorizontalInVerticalType {} {
        ...
        proc WdHorizontalLineAlignment {} {
        ...
        proc WdHorizontalLineWidthType {} {
        ...
        proc WdMeasurementUnitsHID {} {
            # emptyenum - 0
            return { emptyenum 0 }
        }

        proc WdMergeFormatFrom {} {
        ...
        proc WdMultipleWordConversionsMode {} {
            # wdHangulToHanja - 0
            # wdHanjaToHangul - 1
            return { wdHangulToHanja 0 wdHanjaToHangul 1 }
        }

        proc WdNewDocumentType {} {
        ...
        proc WdNumberStyleWordBasicBiDi {} {
        ...
        proc WdPageMovementType {} {
            # wdSideToSide - 2
            # wdVertical - 1
            return { wdSideToSide 2 wdVertical 1 }
        }

        proc WdPageNumberAlignment {} {
        ...
        proc WdPhoneticGuideAlignmentType {} {
        ...
        proc WdRelativeHorizontalPosition {} {
        ...
        proc WdRelativeVerticalPosition {} {
        ...
        proc WdRemoveDocInfoType {} {
            ...
            # wdRDITemplate - 9
            # wdRDIVersions - 3
            return { wdRDIAll 99 wdRDIAtMentions 18 wdRDICommentReactions 21 wdRDIComments 1 wdRDIContentType 16 wdRDIDocumentIntelligence 20 wdRDIDocumentManagementPolicy 15 wdRDIDocumentProperties 8 wdRDIDocumentServerProperties 14 wdRDIDocumentTasks 19 wdRDIDocumentWorkspace 10 wdRDIEmailHeader 5 wdRDIInkAnnotations 11 wdRDIRemovePersonalInformation 4 wdRDIRevisions 2 wdRDIRoutingSlip 6 wdRDISendForReview 7 wdRDITaskpaneWebExtensions 17 wdRDITemplate 9 wdRDIVersions 3 }
        }
        ...
        proc WdRevisionsBalloonMargin {} {
            # wdLeftMargin - 0
            # wdRightMargin - 1
            return { wdLeftMargin 0 wdRightMargin 1 }
        }

        proc WdRevisionsBalloonPrintOrientation {} {
        ...
        proc WdRoutingSlipDelivery {} {
            # wdAllAtOnce - 1
            # wdOneAfterAnother - 0
            return { wdAllAtOnce 1 wdOneAfterAnother 0 }
        }

        proc WdRoutingSlipStatus {} {
            # wdNotYetRouted - 0
            # wdRouteComplete - 2
            # wdRouteInProgress - 1
        ...
        proc WdUpdateStyleListBehavior {} {
        ...
        proc WdWordDialogHID {} {
            # emptyenum - 0
            return { emptyenum 0 }
        }

        proc WdWordDialogTab {} {
        ...
        proc WdXMLSelectionChangeReason {} {
    ...
    array set enums [list \
        WdAlertLevel [Enum::WdAlertLevel] \
        WdAlignmentTabAlignment [Enum::WdAlignmentTabAlignment] \
        WdAlignmentTabRelative [Enum::WdAlignmentTabRelative] \
        WdAnimation [Enum::WdAnimation] \
        WdApplyQuickStyleSets [Enum::WdApplyQuickStyleSets] \
        WdArabicNumeral [Enum::WdArabicNumeral] \
        WdAraSpeller [Enum::WdAraSpeller] \
        WdArrangeStyle [Enum::WdArrangeStyle] \
        WdAutoFitBehavior [Enum::WdAutoFitBehavior] \
        WdAutoMacros [Enum::WdAutoMacros] \
        WdAutoVersions [Enum::WdAutoVersions] \
        WdBaselineAlignment [Enum::WdBaselineAlignment] \
        WdBookmarkSortBy [Enum::WdBookmarkSortBy] \
        WdBorderDistanceFrom [Enum::WdBorderDistanceFrom] \
        WdBorderType [Enum::WdBorderType] \
        WdBorderTypeHID [Enum::WdBorderTypeHID] \
        WdBreakType [Enum::WdBreakType] \
        WdBrowserLevel [Enum::WdBrowserLevel] \
        WdBrowseTarget [Enum::WdBrowseTarget] \
        WdBuildingBlockTypes [Enum::WdBuildingBlockTypes] \
        WdBuiltInProperty [Enum::WdBuiltInProperty] \
        WdBuiltinStyle [Enum::WdBuiltinStyle] \
        WdCalendarType [Enum::WdCalendarType] \
        WdCalendarTypeBi [Enum::WdCalendarTypeBi] \
        WdCaptionLabelID [Enum::WdCaptionLabelID] \
        WdCaptionNumberStyle [Enum::WdCaptionNumberStyle] \
        WdCaptionNumberStyleHID [Enum::WdCaptionNumberStyleHID] \
        WdCaptionPosition [Enum::WdCaptionPosition] \
        WdCellColor [Enum::WdCellColor] \
        WdCellVerticalAlignment [Enum::WdCellVerticalAlignment] \
        WdCharacterCase [Enum::WdCharacterCase] \
        WdCharacterCaseHID [Enum::WdCharacterCaseHID] \
        WdCharacterWidth [Enum::WdCharacterWidth] \
        WdCheckInVersionType [Enum::WdCheckInVersionType] \
        WdChevronConvertRule [Enum::WdChevronConvertRule] \
        WdCollapseDirection [Enum::WdCollapseDirection] \
        WdColor [Enum::WdColor] \
        WdColorIndex [Enum::WdColorIndex] \
        WdColumnWidth [Enum::WdColumnWidth] \
        WdCompareDestination [Enum::WdCompareDestination] \
        WdCompareTarget [Enum::WdCompareTarget] \
        WdCompatibility [Enum::WdCompatibility] \
        WdCompatibilityMode [Enum::WdCompatibilityMode] \
        WdConditionCode [Enum::WdConditionCode] \
        WdConstants [Enum::WdConstants] \
        WdContentControlAppearance [Enum::WdContentControlAppearance] \
        WdContentControlDateStorageFormat [Enum::WdContentControlDateStorageFormat] \
        WdContentControlLevel [Enum::WdContentControlLevel] \
        WdContentControlType [Enum::WdContentControlType] \
        WdContinue [Enum::WdContinue] \
        WdCountry [Enum::WdCountry] \
        WdCursorMovement [Enum::WdCursorMovement] \
        WdCursorType [Enum::WdCursorType] \
        WdCustomLabelPageSize [Enum::WdCustomLabelPageSize] \
        WdDateLanguage [Enum::WdDateLanguage] \
        WdDefaultFilePath [Enum::WdDefaultFilePath] \
        WdDefaultListBehavior [Enum::WdDefaultListBehavior] \
        WdDefaultTableBehavior [Enum::WdDefaultTableBehavior] \
        WdDeleteCells [Enum::WdDeleteCells] \
        WdDeletedTextMark [Enum::WdDeletedTextMark] \
        WdDiacriticColor [Enum::WdDiacriticColor] \
        WdDictionaryType [Enum::WdDictionaryType] \
        WdDictionaryTypeHID [Enum::WdDictionaryTypeHID] \
        WdDisableFeaturesIntroducedAfter [Enum::WdDisableFeaturesIntroducedAfter] \
        WdDocPartInsertOptions [Enum::WdDocPartInsertOptions] \
        WdDocumentDirection [Enum::WdDocumentDirection] \
        WdDocumentKind [Enum::WdDocumentKind] \
        WdDocumentMedium [Enum::WdDocumentMedium] \
        WdDocumentType [Enum::WdDocumentType] \
        WdDocumentViewDirection [Enum::WdDocumentViewDirection] \
        WdDropPosition [Enum::WdDropPosition] \
        WdEditionOption [Enum::WdEditionOption] \
        WdEditionType [Enum::WdEditionType] \
        WdEditorType [Enum::WdEditorType] \
        WdEmailHTMLFidelity [Enum::WdEmailHTMLFidelity] \
        WdEmphasisMark [Enum::WdEmphasisMark] \
        WdEnableCancelKey [Enum::WdEnableCancelKey] \
        WdEncloseStyle [Enum::WdEncloseStyle] \
        WdEnclosureType [Enum::WdEnclosureType] \
        WdEndnoteLocation [Enum::WdEndnoteLocation] \
        WdEnvelopeOrientation [Enum::WdEnvelopeOrientation] \
        WdExportCreateBookmarks [Enum::WdExportCreateBookmarks] \
        WdExportFormat [Enum::WdExportFormat] \
        WdExportItem [Enum::WdExportItem] \
        WdExportOptimizeFor [Enum::WdExportOptimizeFor] \
        WdExportRange [Enum::WdExportRange] \
        WdFarEastLineBreakLanguageID [Enum::WdFarEastLineBreakLanguageID] \
        WdFarEastLineBreakLevel [Enum::WdFarEastLineBreakLevel] \
        WdFieldKind [Enum::WdFieldKind] \
        WdFieldShading [Enum::WdFieldShading] \
        WdFieldType [Enum::WdFieldType] \
        WdFindMatch [Enum::WdFindMatch] \
        WdFindWrap [Enum::WdFindWrap] \
        WdFlowDirection [Enum::WdFlowDirection] \
        WdFontBias [Enum::WdFontBias] \
        WdFootnoteLocation [Enum::WdFootnoteLocation] \
        WdFramePosition [Enum::WdFramePosition] \
        WdFramesetNewFrameLocation [Enum::WdFramesetNewFrameLocation] \
        WdFramesetSizeType [Enum::WdFramesetSizeType] \
        WdFramesetType [Enum::WdFramesetType] \
        WdFrameSizeRule [Enum::WdFrameSizeRule] \
        WdFrenchSpeller [Enum::WdFrenchSpeller] \
        WdGoToDirection [Enum::WdGoToDirection] \
        WdGoToItem [Enum::WdGoToItem] \
        WdGranularity [Enum::WdGranularity] \
        WdGutterStyle [Enum::WdGutterStyle] \
        WdGutterStyleOld [Enum::WdGutterStyleOld] \
        WdHeaderFooterIndex [Enum::WdHeaderFooterIndex] \
        WdHeadingSeparator [Enum::WdHeadingSeparator] \
        WdHebSpellStart [Enum::WdHebSpellStart] \
        WdHelpType [Enum::WdHelpType] \
        WdHelpTypeHID [Enum::WdHelpTypeHID] \
        WdHighAnsiText [Enum::WdHighAnsiText] \
        WdHorizontalInVerticalType [Enum::WdHorizontalInVerticalType] \
        WdHorizontalLineAlignment [Enum::WdHorizontalLineAlignment] \
        WdHorizontalLineWidthType [Enum::WdHorizontalLineWidthType] \
        WdIMEMode [Enum::WdIMEMode] \
        WdIndexFilter [Enum::WdIndexFilter] \
        WdIndexFormat [Enum::WdIndexFormat] \
        WdIndexSortBy [Enum::WdIndexSortBy] \
        WdIndexType [Enum::WdIndexType] \
        WdInformation [Enum::WdInformation] \
        WdInlineShapeType [Enum::WdInlineShapeType] \
        WdInsertCells [Enum::WdInsertCells] \
        WdInsertedTextMark [Enum::WdInsertedTextMark] \
        WdInternationalIndex [Enum::WdInternationalIndex] \
        WdJustificationMode [Enum::WdJustificationMode] \
        WdKana [Enum::WdKana] \
        WdKey [Enum::WdKey] \
        WdKeyCategory [Enum::WdKeyCategory] \
        WdLanguageID [Enum::WdLanguageID] \
        WdLanguageID2000 [Enum::WdLanguageID2000] \
        WdLayoutMode [Enum::WdLayoutMode] \
        WdLetterheadLocation [Enum::WdLetterheadLocation] \
        WdLetterStyle [Enum::WdLetterStyle] \
        WdLigatures [Enum::WdLigatures] \
        WdLineEndingType [Enum::WdLineEndingType] \
        WdLineSpacing [Enum::WdLineSpacing] \
        WdLineStyle [Enum::WdLineStyle] \
        WdLineType [Enum::WdLineType] \
        WdLineWidth [Enum::WdLineWidth] \
        WdLinkType [Enum::WdLinkType] \
        WdListApplyTo [Enum::WdListApplyTo] \
        WdListGalleryType [Enum::WdListGalleryType] \
        WdListLevelAlignment [Enum::WdListLevelAlignment] \
        WdListNumberStyle [Enum::WdListNumberStyle] \
        WdListNumberStyleHID [Enum::WdListNumberStyleHID] \
        WdListType [Enum::WdListType] \
        WdLockType [Enum::WdLockType] \
        WdMailerPriority [Enum::WdMailerPriority] \
        WdMailMergeActiveRecord [Enum::WdMailMergeActiveRecord] \
        WdMailMergeComparison [Enum::WdMailMergeComparison] \
        WdMailMergeDataSource [Enum::WdMailMergeDataSource] \
        WdMailMergeDefaultRecord [Enum::WdMailMergeDefaultRecord] \
        WdMailMergeDestination [Enum::WdMailMergeDestination] \
        WdMailMergeMailFormat [Enum::WdMailMergeMailFormat] \
        WdMailMergeMainDocType [Enum::WdMailMergeMainDocType] \
        WdMailMergeState [Enum::WdMailMergeState] \
        WdMailSystem [Enum::WdMailSystem] \
        WdMappedDataFields [Enum::WdMappedDataFields] \
        WdMeasurementUnits [Enum::WdMeasurementUnits] \
        WdMeasurementUnitsHID [Enum::WdMeasurementUnitsHID] \
        WdMergeFormatFrom [Enum::WdMergeFormatFrom] \
        WdMergeSubType [Enum::WdMergeSubType] \
        WdMergeTarget [Enum::WdMergeTarget] \
        WdMonthNames [Enum::WdMonthNames] \
        WdMoveFromTextMark [Enum::WdMoveFromTextMark] \
        WdMovementType [Enum::WdMovementType] \
        WdMoveToTextMark [Enum::WdMoveToTextMark] \
        WdMultipleWordConversionsMode [Enum::WdMultipleWordConversionsMode] \
        WdNewDocumentType [Enum::WdNewDocumentType] \
        WdNoteNumberStyle [Enum::WdNoteNumberStyle] \
        WdNoteNumberStyleHID [Enum::WdNoteNumberStyleHID] \
        WdNumberForm [Enum::WdNumberForm] \
        WdNumberingRule [Enum::WdNumberingRule] \
        WdNumberSpacing [Enum::WdNumberSpacing] \
        WdNumberStyleWordBasicBiDi [Enum::WdNumberStyleWordBasicBiDi] \
        WdNumberType [Enum::WdNumberType] \
        WdOLEPlacement [Enum::WdOLEPlacement] \
        WdOLEType [Enum::WdOLEType] \
        WdOLEVerb [Enum::WdOLEVerb] \
        WdOMathBreakBin [Enum::WdOMathBreakBin] \
        WdOMathBreakSub [Enum::WdOMathBreakSub] \
        WdOMathFracType [Enum::WdOMathFracType] \
        WdOMathFunctionType [Enum::WdOMathFunctionType] \
        WdOMathHorizAlignType [Enum::WdOMathHorizAlignType] \
        WdOMathJc [Enum::WdOMathJc] \
        WdOMathShapeType [Enum::WdOMathShapeType] \
        WdOMathSpacingRule [Enum::WdOMathSpacingRule] \
        WdOMathType [Enum::WdOMathType] \
        WdOMathVertAlignType [Enum::WdOMathVertAlignType] \
        WdOpenFormat [Enum::WdOpenFormat] \
        WdOrganizerObject [Enum::WdOrganizerObject] \
        WdOrientation [Enum::WdOrientation] \
        WdOriginalFormat [Enum::WdOriginalFormat] \
        WdOutlineLevel [Enum::WdOutlineLevel] \
        WdPageBorderArt [Enum::WdPageBorderArt] \
        WdPageColor [Enum::WdPageColor] \
        WdPageFit [Enum::WdPageFit] \
        WdPageMovementType [Enum::WdPageMovementType] \
        WdPageNumberAlignment [Enum::WdPageNumberAlignment] \
        WdPageNumberStyle [Enum::WdPageNumberStyle] \
        WdPageNumberStyleHID [Enum::WdPageNumberStyleHID] \
        WdPaperSize [Enum::WdPaperSize] \
        WdPaperTray [Enum::WdPaperTray] \
        WdParagraphAlignment [Enum::WdParagraphAlignment] \
        WdParagraphAlignmentHID [Enum::WdParagraphAlignmentHID] \
        WdPartOfSpeech [Enum::WdPartOfSpeech] \
        WdPasteDataType [Enum::WdPasteDataType] \
        WdPasteOptions [Enum::WdPasteOptions] \
        WdPhoneticGuideAlignmentType [Enum::WdPhoneticGuideAlignmentType] \
        WdPictureLinkType [Enum::WdPictureLinkType] \
        WdPortugueseReform [Enum::WdPortugueseReform] \
        WdPreferredWidthType [Enum::WdPreferredWidthType] \
        WdPrintOutItem [Enum::WdPrintOutItem] \
        WdPrintOutPages [Enum::WdPrintOutPages] \
        WdPrintOutRange [Enum::WdPrintOutRange] \
        WdProofreadingErrorType [Enum::WdProofreadingErrorType] \
        WdProtectedViewCloseReason [Enum::WdProtectedViewCloseReason] \
        WdProtectionType [Enum::WdProtectionType] \
        WdReadingLayoutMargin [Enum::WdReadingLayoutMargin] \
        WdReadingOrder [Enum::WdReadingOrder] \
        WdRecoveryType [Enum::WdRecoveryType] \
        WdRectangleType [Enum::WdRectangleType] \
        WdReferenceKind [Enum::WdReferenceKind] \
        WdReferenceType [Enum::WdReferenceType] \
        WdRelativeHorizontalPosition [Enum::WdRelativeHorizontalPosition] \
        WdRelativeHorizontalSize [Enum::WdRelativeHorizontalSize] \
        WdRelativeVerticalPosition [Enum::WdRelativeVerticalPosition] \
        WdRelativeVerticalSize [Enum::WdRelativeVerticalSize] \
        WdRelocate [Enum::WdRelocate] \
        WdRemoveDocInfoType [Enum::WdRemoveDocInfoType] \
        WdReplace [Enum::WdReplace] \
        WdRevisedLinesMark [Enum::WdRevisedLinesMark] \
        WdRevisedPropertiesMark [Enum::WdRevisedPropertiesMark] \
        WdRevisionsBalloonMargin [Enum::WdRevisionsBalloonMargin] \
        WdRevisionsBalloonPrintOrientation [Enum::WdRevisionsBalloonPrintOrientation] \
        WdRevisionsBalloonWidthType [Enum::WdRevisionsBalloonWidthType] \
        WdRevisionsMarkup [Enum::WdRevisionsMarkup] \
        WdRevisionsMode [Enum::WdRevisionsMode] \
        WdRevisionsView [Enum::WdRevisionsView] \
        WdRevisionsWrap [Enum::WdRevisionsWrap] \
        WdRevisionType [Enum::WdRevisionType] \
        WdRoutingSlipDelivery [Enum::WdRoutingSlipDelivery] \
        WdRoutingSlipStatus [Enum::WdRoutingSlipStatus] \
        WdRowAlignment [Enum::WdRowAlignment] \
        WdRowHeightRule [Enum::WdRowHeightRule] \
        WdRulerStyle [Enum::WdRulerStyle] \
        WdSalutationGender [Enum::WdSalutationGender] \
        WdSalutationType [Enum::WdSalutationType] \
        WdSaveFormat [Enum::WdSaveFormat] \
        WdSaveOptions [Enum::WdSaveOptions] \
        WdScrollbarType [Enum::WdScrollbarType] \
        WdSectionDirection [Enum::WdSectionDirection] \
        WdSectionStart [Enum::WdSectionStart] \
        WdSeekView [Enum::WdSeekView] \
        WdSelectionFlags [Enum::WdSelectionFlags] \
        WdSelectionType [Enum::WdSelectionType] \
        WdSeparatorType [Enum::WdSeparatorType] \
        WdShapePosition [Enum::WdShapePosition] \
        WdShapePositionRelative [Enum::WdShapePositionRelative] \
        WdShapeSizeRelative [Enum::WdShapeSizeRelative] \
        WdShowFilter [Enum::WdShowFilter] \
        WdShowSourceDocuments [Enum::WdShowSourceDocuments] \
        WdSmartTagControlType [Enum::WdSmartTagControlType] \
        WdSortFieldType [Enum::WdSortFieldType] \
        WdSortFieldTypeHID [Enum::WdSortFieldTypeHID] \
        WdSortOrder [Enum::WdSortOrder] \
        WdSortSeparator [Enum::WdSortSeparator] \
        WdSpanishSpeller [Enum::WdSpanishSpeller] \
        WdSpecialPane [Enum::WdSpecialPane] \
        WdSpellingErrorType [Enum::WdSpellingErrorType] \
        WdSpellingWordType [Enum::WdSpellingWordType] \
        WdStatistic [Enum::WdStatistic] \
        WdStatisticHID [Enum::WdStatisticHID] \
        WdStoryType [Enum::WdStoryType] \
        WdStyleSheetLinkType [Enum::WdStyleSheetLinkType] \
        WdStyleSheetPrecedence [Enum::WdStyleSheetPrecedence] \
        WdStyleSort [Enum::WdStyleSort] \
        WdStyleType [Enum::WdStyleType] \
        WdStylisticSet [Enum::WdStylisticSet] \
        WdSubscriberFormats [Enum::WdSubscriberFormats] \
        WdSummaryLength [Enum::WdSummaryLength] \
        WdSummaryMode [Enum::WdSummaryMode] \
        WdTabAlignment [Enum::WdTabAlignment] \
        WdTabLeader [Enum::WdTabLeader] \
        WdTabLeaderHID [Enum::WdTabLeaderHID] \
        WdTableDirection [Enum::WdTableDirection] \
        WdTableFieldSeparator [Enum::WdTableFieldSeparator] \
        WdTableFormat [Enum::WdTableFormat] \
        WdTableFormatApply [Enum::WdTableFormatApply] \
        WdTablePosition [Enum::WdTablePosition] \
        WdTaskPanes [Enum::WdTaskPanes] \
        WdTCSCConverterDirection [Enum::WdTCSCConverterDirection] \
        WdTemplateType [Enum::WdTemplateType] \
        WdTextboxTightWrap [Enum::WdTextboxTightWrap] \
        WdTextFormFieldType [Enum::WdTextFormFieldType] \
        WdTextOrientation [Enum::WdTextOrientation] \
        WdTextOrientationHID [Enum::WdTextOrientationHID] \
        WdTextureIndex [Enum::WdTextureIndex] \
        WdThemeColorIndex [Enum::WdThemeColorIndex] \
        WdToaFormat [Enum::WdToaFormat] \
        WdTocFormat [Enum::WdTocFormat] \
        WdTofFormat [Enum::WdTofFormat] \
        WdTrailingCharacter [Enum::WdTrailingCharacter] \
        WdTwoLinesInOneType [Enum::WdTwoLinesInOneType] \
        WdUnderline [Enum::WdUnderline] \
        WdUnits [Enum::WdUnits] \
        WdUpdateStyleListBehavior [Enum::WdUpdateStyleListBehavior] \
        WdUseFormattingFrom [Enum::WdUseFormattingFrom] \
        WdVerticalAlignment [Enum::WdVerticalAlignment] \
        WdViewType [Enum::WdViewType] \
        WdViewTypeOld [Enum::WdViewTypeOld] \
        WdVisualSelection [Enum::WdVisualSelection] \
        WdWindowState [Enum::WdWindowState] \
        WdWindowType [Enum::WdWindowType] \
        WdWordDialog [Enum::WdWordDialog] \
        WdWordDialogHID [Enum::WdWordDialogHID] \
        WdWordDialogTab [Enum::WdWordDialogTab] \
        WdWordDialogTabHID [Enum::WdWordDialogTabHID] \
        WdWrapSideType [Enum::WdWrapSideType] \
        WdWrapType [Enum::WdWrapType] \
        WdWrapTypeMerged [Enum::WdWrapTypeMerged] \
        WdXMLNodeLevel [Enum::WdXMLNodeLevel] \
        WdXMLNodeType [Enum::WdXMLNodeType] \
        WdXMLSelectionChangeReason [Enum::WdXMLSelectionChangeReason] \
        WdXMLValidationStatus [Enum::WdXMLValidationStatus] \
