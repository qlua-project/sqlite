...
set _CawtSubDirs [list CawtCore CawtOffice CawtExcel CawtWord CawtPpt CawtOutlook \
                       CawtOneNote CawtOcr CawtSapi CawtReader CawtExplorer CawtEarth CawtMatlab]

_SetupCawtPkgs $dir 3.0.0 $_CawtSubDirs

package ifneeded cawt 3.0.0 [list _LoadCawtPkgs $dir 3.0.0 $_CawtSubDirs]
