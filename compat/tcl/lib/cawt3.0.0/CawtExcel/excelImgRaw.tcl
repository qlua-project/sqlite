...
namespace eval Excel {
    ...
    proc _PutRawImageHeader { rawFp width height pixelType } {
        ...
        Excel::_PrintHeaderLine $rawFp [format "PixelType=%s" $pixelType]
    }
    ...
    proc WriteRawImageFile { matrixList rawImgFile { pixelType "float" } } {
    ...
    proc WorksheetToRawImageFile { worksheetId rawFileName { useHeader true } { pixelType "float" } } {
    ...
    proc ExcelFileToRawImageFile { excelFileName rawFileName { worksheetNameOrIndex 0 } \
                                  { useHeader true } { quitExcel true } { pixelType "float" } } {
