...
namespace eval Cawt {
    ...
    namespace export GetColorNames
    namespace export IsHexColor
    namespace export IsNameColor
    namespace export IsOfficeColor
    namespace export IsRgbColor
    namespace export OfficeColorToRgb
    namespace export RgbToOfficeColor

    variable sColorNameList

    proc _IsValidRgb { r g b } {
