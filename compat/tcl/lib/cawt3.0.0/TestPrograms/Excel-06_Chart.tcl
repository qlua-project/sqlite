...
Excel SetChartTicks $lineChartId1 "x" 2 2
...
set seriesId [Excel GetChartSeries $pointChartId 1]
Excel SetSeriesAttributes $seriesId \
      -markerstyle xlMarkerStyleSquare \
      -linewidth 0.5 \
      -linecolor "green"
Excel AddSeriesTrendLine $seriesId \
      -equation true -rsquared true -type xlLinear \
      -linewidth 1.0 \
      -linecolor "red"
