# Test CawtExcel procedures to exchange data between Excel and 32-bit
# floating point RAW images.
#
...
Excel ExcelFileToRawImageFile $xlsOutFile2 $rawOutFile3 "RawImage" true true
