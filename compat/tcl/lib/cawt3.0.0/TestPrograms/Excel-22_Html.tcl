...
set workbookId [Excel OpenWorkbook $appId $xlsFile -readonly true]
...
Excel ExcelFileToHtmlFile $xlsFile $outFileHtml2 -worksheet "SampleTable" -quit true -target false
