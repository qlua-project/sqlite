# Test CawtExcel procedures to exchange data between Excel and 16-bit
# integer RAW images.
#
...
set rawFile "testIn/gradient-16bit.raw"
...
file mkdir testOut
set xlsOutFile1 [file join [pwd] "testOut" "Excel-11_RawImage-16bit-1"]
append xlsOutFile1 [Excel GetExtString $excelAppId1]
file delete -force $xlsOutFile1
set xlsOutFile2 [file join [pwd] "testOut" "Excel-11_RawImage-16bit-2"]
append xlsOutFile2 [Excel GetExtString $excelAppId1]
file delete -force $xlsOutFile2
set rawOutFile1 [file join [pwd] "testOut" "Excel-11_RawImage-16bit-1.raw"]
file delete -force $rawOutFile1
set rawOutFile2 [file join [pwd] "testOut" "Excel-11_RawImage-16bit-2.raw"]
file delete -force $rawOutFile2
set rawOutFile3 [file join [pwd] "testOut" "Excel-11_RawImage-16bit-3.raw"]
...
set t1 [clock clicks -milliseconds]
Excel WorksheetToRawImageFile $worksheetId $rawOutFile1 $useHeader "short"
set t2 [clock clicks -milliseconds]
...
set t1 [clock clicks -milliseconds]
Excel WorksheetToRawImageFile $worksheetId $rawOutFile2 $useHeader "short"
set t2 [clock clicks -milliseconds]
puts "WorksheetToRawImageFile: [expr $t2 - $t1] ms (using header: $useHeader)."
...
Excel ExcelFileToRawImageFile $xlsOutFile2 $rawOutFile3 "RawImage" true true "short"
