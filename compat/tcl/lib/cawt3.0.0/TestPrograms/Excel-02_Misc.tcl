...
Excel SetRangeFillColor $rangeId 255 0 0
Excel SetRangeTextColor $rangeId 0 255 0
Cawt CheckList {5 1} [Excel GetRangeAsIndex $rangeId] "GetRangeAsIndex"
...
set expVal [format "0%s000" [Excel GetDecimalSeparator $appId]]
Cawt CheckString $expVal  [Excel GetRangeFormat $rangeId] "GetRangeFormat"
...
# Test inserting multiple lines into a cell.
Excel SetCellValue $worksheetId [expr $numRows+1] 1 "Line1\nLine2\nLine3"
...
# Test different ways of copying cell ranges.
set rangeWorksheetId [Excel AddWorksheet $workbookId "CopyRange"]
set fromRangeId [Excel SelectRangeByString $copyWorksheetId "A1:H3"]

Excel SetCellValue $rangeWorksheetId 1 1 "xlPasteAll"
set toRangeId [Excel SelectRangeByString $rangeWorksheetId "A2"]
Excel CopyRange $fromRangeId $toRangeId

Excel SetCellValue $rangeWorksheetId 6 1 "xlPasteAllExceptBorders"
set toRangeId [Excel SelectRangeByString $rangeWorksheetId "A7:H9"]
Excel CopyRange $fromRangeId $toRangeId xlPasteAllExceptBorders

Excel SetCellValue $rangeWorksheetId 11 1 "xlPasteValues"
set toRangeId [Excel SelectRangeByString $rangeWorksheetId "A12:H14"]
Excel CopyRange $fromRangeId $toRangeId xlPasteValues
