...
Cawt CheckString "Slide1" [Ppt GetSlideName $slideId1] "SlideName before"
Ppt SetSlideName $slideId1 "MySlide"
Cawt CheckString "MySlide" [Ppt GetSlideName $slideId1] "SlideName after"

set slideFoundId [Ppt GetSlideIdByName $presId "MySlide"]
Cawt CheckString [Ppt GetSlideName $slideId1] [Ppt GetSlideName $slideFoundId] \
                 "GetSlideIdByName"
