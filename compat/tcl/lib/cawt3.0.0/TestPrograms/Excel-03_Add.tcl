...
# Check the A1 to index conversion procedures.
Cawt CheckString "E-10" [Excel GetCellValueA1 $worksheetIds(1) "J15"] "GetCellValueA1"
set rangeId [Excel SelectRangeByString $worksheetIds(1) "J15"]
Cawt CheckList { 15 10 } [Excel GetRangeAsIndex $rangeId] "GetRangeAsIndex"
set rangeId [Excel SelectRangeByString $worksheetIds(1) "I14:J15"]
Cawt CheckList { 14 9 15 10 } [Excel GetRangeAsIndex $rangeId] "GetRangeAsIndex"
...
# Add 2 hidden worksheets.
set worksheetId [Excel AddWorksheet $workbookId "Hidden1" xlSheetHidden]
set worksheetId [Excel AddWorksheet $workbookId "Hidden2" -visible xlSheetHidden]

set num [Excel GetNumWorksheets $workbookId]
Cawt CheckNumber 5 $num "Number of worksheets finally"
...
Cawt CheckBoolean true [Excel IsWorkbookOpen $appId2 $xlsFile] "IsWorkbookOpen"
Excel Close $workbookId
Cawt CheckBoolean false [Excel IsWorkbookOpen $appId2 $xlsFile] "IsWorkbookOpen"
