...
foreach searchStr { "italic" "Manfred" } expected { 1 0 } {
    set numFound [Word FindString $inDocId $searchStr]
    Cawt CheckNumber $expected $numFound "FindString docId   $searchStr"

    set numFound [Word FindString $range $searchStr]
    Cawt CheckNumber $expected $numFound "FindString rangeId $searchStr"
}
