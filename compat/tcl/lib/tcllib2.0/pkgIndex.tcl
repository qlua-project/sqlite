...
apply {{maindir} {
	...
	struct tar tcllibc tepam term textutil tie tiff tool transfer
	treeql try udpcluster uev units uri uuid valtype virtchannel_base
	virtchannel_core virtchannel_transform websocket wip yaml zip
    } {
